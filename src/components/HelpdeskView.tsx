...
import { Search, Filter, Plus, HeadphonesIcon } from 'lucide-react';
    ...
    <div className="flex flex-col h-full max-w-[1600px] mx-auto w-full">
      <div className="p-8 pb-0">
        <div className="flex justify-between items-end mb-6">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Helpdesk & Support</h1>
            <p className="text-slate-500 mt-1 text-sm">Manage support tickets and SLAs.</p>
          </div>
